...
We utilized the "a_star.py" code from https://github.com/AtsushiSakai/PythonRobotics.git, and also used "the Animated scatter saved as GIF code" from https://matplotlib.org/stable/gallery/animation/simple_scatter.html for save the following gif from the result animation.
